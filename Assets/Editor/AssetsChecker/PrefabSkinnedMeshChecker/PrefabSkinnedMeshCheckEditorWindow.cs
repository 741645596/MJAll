...
/// 预制蒙皮网格检测,EditorUI界面
/// </summary>
public class PrefabSkinnedMeshCheckEditorWindow : EditorWindow
{
    #region 变量
    ...
    private PrefabSkinnedMeshChecker         _checker;                // 检测逻辑
    ...
    {
        titleContent = new GUIContent("预制蒙皮网格资源");
    }
    ...
    private static void _BottomBar(List<PrefabSkinnedMeshAssetInfo> atlasList, long totalFileSize)
    {
    ...
    private long _SetFileInfo(List<PrefabSkinnedMeshAssetInfo> atlasList)
    {
    ...
    private void _OnlyShow_FixAll(List<PrefabSkinnedMeshAssetInfo> atlasList)
    {
        EditorGUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
    ...
    /// </summary>
    /// <param name="atlasList"> 检测的文件夹信息 </param>
    private void _FixAll(List<PrefabSkinnedMeshAssetInfo> atlasList)
    {
    ...
    public void InitConfig(AssetsCheckEditorWindow.Settings settings)
    {
        ...
        _checker  = new PrefabSkinnedMeshChecker(settings); // 检测逻辑
        _checker.AddRule(new PrefabSkinnedMeshRule());      // 压缩格式检测规范
    }
    ...
    private void _Fix(bool matchRule, PrefabSkinnedMeshAssetInfo info)
    {
    ...
    /// </summary>
    /// <param name="info"> 文件夹信息 </param>
    private void _FindRes(PrefabSkinnedMeshAssetInfo info)
    {
