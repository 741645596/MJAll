...
/// 预制网格检测,EditorUI界面
/// </summary>
public class PrefabMeshCheckEditorWindow : EditorWindow
{
    #region 变量
    ...
    private PrefabMeshChecker                _checker;                // 检测逻辑
    ...
    {
        titleContent = new GUIContent("预制网格资源");
    }
    ...
    private static void _BottomBar(List<PrefabMeshAssetInfo> atlasList, long totalFileSize)
    {
    ...
    private long _SetFileInfo(List<PrefabMeshAssetInfo> atlasList)
    {
    ...
    private void _OnlyShow_FixAll(List<PrefabMeshAssetInfo> atlasList)
    {
        EditorGUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
    ...
    /// </summary>
    /// <param name="atlasList"> 检测的文件夹信息 </param>
    private void _FixAll(List<PrefabMeshAssetInfo> atlasList)
    {
    ...
    public void InitConfig(AssetsCheckEditorWindow.Settings settings)
    {
        ...
        _checker  = new PrefabMeshChecker(settings); // 检测逻辑
        _checker.AddRule(new PrefabMeshRule());      // 压缩格式检测规范
    }
    ...
    private void _Fix(bool matchRule, PrefabMeshAssetInfo info)
    {
    ...
    /// </summary>
    /// <param name="info"> 文件夹信息 </param>
    private void _FindRes(PrefabMeshAssetInfo info)
    {
