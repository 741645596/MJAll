...
/// 预制UI检测,EditorUI界面
/// </summary>
public class PrefabUICheckEditorWindow : EditorWindow
{
    #region 变量
    ...
    private PrefabUIChecker                  _checker;                //检测逻辑
    ...
    {
        titleContent = new GUIContent("预制UI资源");
    }
    ...
    private static void _BottomBar(List<PrefabUIAssetInfo> atlasList, long totalFileSize)
    {
    ...
    private long _SetFileInfo(List<PrefabUIAssetInfo> atlasList)
    {
    ...
    private void _OnlyShow_FixAll(List<PrefabUIAssetInfo> atlasList)
    {
        EditorGUILayout.BeginHorizontal();
        GUILayout.FlexibleSpace();
    ...
    /// </summary>
    /// <param name="atlasList"> 检测的文件夹信息 </param>
    private void _FixAll(List<PrefabUIAssetInfo> atlasList)
    {
    ...
    public void InitConfig(AssetsCheckEditorWindow.Settings settings)
    {
        ...
        _checker  = new PrefabUIChecker(settings); //检测逻辑
        _checker.AddRule(new PrefabUIRule());      //压缩格式检测规范
    }
    ...
    private void _Fix(bool matchRule, PrefabUIAssetInfo info)
    {
    ...
    /// </summary>
    /// <param name="info"> 文件夹信息 </param>
    private void _FindRes(PrefabUIAssetInfo info)
    {
