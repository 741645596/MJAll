...
public class BaseStageAdaptor : CrossBindingAdaptor
{
    ...
    private static CrossBindingMethodInfo<bool> mVMethod_OnApplicationFocus = new CrossBindingMethodInfo<bool>("OnApplicationFocus");
    private static CrossBindingMethodInfo<float> mVMethod_OnUpdate = new CrossBindingMethodInfo<float>("OnUpdate");


    public override Type BaseCLRType => typeof(BaseStage);
    ...
    public class Adaptor : BaseStage, CrossBindingAdaptorType
    {
        ...
        public override void OnApplicationFocus(bool bFocus)
        {
            if (mVMethod_OnApplicationFocus.CheckShouldInvokeBase(instance))
                base.OnApplicationFocus(bFocus);
            else
                mVMethod_OnApplicationFocus.Invoke(instance, bFocus);
        }
