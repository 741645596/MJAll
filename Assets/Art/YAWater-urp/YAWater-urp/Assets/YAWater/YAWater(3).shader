...
float4 _AlphaTex_ST;
			...
			half4 frag (v2f i) : SV_Target
			{
			    ...
			    float4 pro= SAMPLE_TEXTURE2D(_GradientTex, sampler_GradientTex, i.projPos.xy /i.projPos.w).r;

                swelledNormal.xz *=max(pro, 0.5);
				...
				*/
			    ...
			    float4 al = SAMPLE_TEXTURE2D(_AlphaTex, sampler_AlphaTex, i.uv);
  				alpha *= al.r;
